...
-- P.255 / Q. 7-50
UPDATE PRODUCTS SET PROD_PRI = (PROD_PRI * 0.1);
SELECT * FROM PRODUCTS;
UPDATE PRODUCTS SET PROD_PRI = (PROD_PRI * 10);
UPDATE PRODUCTS SET PROD_PRI = (PROD_PRI * 1.1);

UPDATE ORDERS SET ORDER_QTY = 5 WHERE CUST_CD = (SELECT CUST_CD FROM CUSTOMER WHERE CUST_NM = '정소화');
SELECT * FROM ORDERS;
UPDATE ORDERS SET ORDER_QTY = 5 IN (SELECT CUST_CD );



SELECT DISTINCT ORD_CD FROM ORDERS WHERE CUST_CD = 'BANANA';
--SELECT ORD_CD FROM ORDERS WHERE CUST_CD = 'BANANA' GROUP BY CUST_CD;
--SELECT ORD_CD FROM ORDERS GROUP BY CUST_CD HAVING CUST_CD = 'BANANA';
